#!/usr/bin/env python3
"""Native Blockbench repair gate for seven Packet 002 representatives.
...
INTEGRATION_COMMIT = "0a55eee35c3206155cb8fd96fb40ba86ac17af4c"
KEYFRAME_TOLERANCE_SECONDS = 0.026
RECEIPT_NAME = "ashen-representative-native-receipt.json"
ZERO = [0.0, 0.0, 0.0]
...
SPECS: dict[str, dict[str, Any]] = {
    "ash_drake": {
        ...
        "clips": {
            "idle": clip(3.2, True, 0.8, {
                "body": [frames("rotation", (0.0, ZERO), (0.8, [1.5, 0.0, 0.0]), (1.6, ZERO), (2.4, [-1.0, 0.0, 0.0]), (3.2, ZERO))],
                "tail": [frames("rotation", (0.0, ZERO), (0.8, [0.0, 5.0, 0.0]), (1.6, ZERO), (2.4, [0.0, -4.0, 0.0]), (3.2, ZERO))],
            }),
            "walk": clip(1.0, True, 0.25, {
                ...
                "leg_bl": [frames("rotation", (0.0, [-17.0, 0.0, 0.0]), (0.5, [17.0, 0.0, 0.0]), (1.0, [-17.0, 0.0, 0.0]))],
                "leg_br": [frames("rotation", (0.0, [17.0, 0.0, 0.0]), (0.5, [-17.0, 0.0, 0.0]), (1.0, [17.0, 0.0, 0.0]))],
            }),
            "wing_flap_hop": clip(1.0, False, 0.45, {
                "body": [frames("position", (0.0, ZERO), (0.25, [0.0, 0.5, 0.0]), (0.5, [0.0, 1.25, 0.0]), (0.75, [0.0, 0.4, 0.0]), (1.0, ZERO))],
                "wing_l": [frames("rotation", (0.0, ZERO), (0.25, [0.0, 0.0, -28.0]), (0.5, [0.0, 0.0, 18.0]), (0.75, [0.0, 0.0, -18.0]), (1.0, ZERO))],
                "wing_r": [frames("rotation", (0.0, ZERO), (0.25, [0.0, 0.0, 28.0]), (0.5, [0.0, 0.0, -18.0]), (0.75, [0.0, 0.0, 18.0]), (1.0, ZERO))],
            }),
            "bite": clip(0.7, False, 0.32, {
                "head": [frames("rotation", (0.0, ZERO), (0.2, [-12.0, 0.0, 0.0]), (0.35, [18.0, 0.0, 0.0]), (0.7, ZERO))],
                "body": [frames("position", (0.0, ZERO), (0.35, [0.0, 0.0, -0.8]), (0.7, ZERO))],
            }),
    ...
    "ember_crow": {
        ...
        "clips": {
            "idle_perch": clip(3.2, True, 0.8, {
                "head": [frames("rotation", (0.0, ZERO), (0.8, [3.0, -8.0, 0.0]), (1.6, ZERO), (2.4, [2.0, 7.0, 0.0]), (3.2, ZERO))],
                "wing_l": [frames("rotation", (0.0, ZERO), (1.6, [0.0, 0.0, -3.0]), (3.2, ZERO))],
                "wing_r": [frames("rotation", (0.0, ZERO), (1.6, [0.0, 0.0, 3.0]), (3.2, ZERO))],
            }),
            "fly": clip(0.8, True, 0.2, {
                "wing_l": [frames("rotation", (0.0, [0.0, 0.0, -34.0]), (0.2, [0.0, 0.0, 18.0]), (0.4, [0.0, 0.0, 34.0]), (0.6, [0.0, 0.0, 18.0]), (0.8, [0.0, 0.0, -34.0]))],
                "wing_r": [frames("rotation", (0.0, [0.0, 0.0, 34.0]), (0.2, [0.0, 0.0, -18.0]), (0.4, [0.0, 0.0, -34.0]), (0.6, [0.0, 0.0, -18.0]), (0.8, [0.0, 0.0, 34.0]))],
                "body": [frames("position", (0.0, ZERO), (0.2, [0.0, 0.35, 0.0]), (0.4, ZERO), (0.6, [-0.0, -0.25, 0.0]), (0.8, ZERO))],
            }),
            "glide": clip(1.6, True, 0.4, {
                "wing_l": [frames("rotation", (0.0, [0.0, 0.0, -24.0]), (0.8, [0.0, 0.0, -20.0]), (1.6, [0.0, 0.0, -24.0]))],
                "wing_r": [frames("rotation", (0.0, [0.0, 0.0, 24.0]), (0.8, [0.0, 0.0, 20.0]), (1.6, [0.0, 0.0, 24.0]))],
                "body": [frames("rotation", (0.0, [-4.0, 0.0, 0.0]), (0.8, [-2.0, 0.0, 0.0]), (1.6, [-4.0, 0.0, 0.0]))],
            }),
            "peck": clip(0.6, False, 0.3, {"head": [frames("rotation", (0.0, ZERO), (0.18, [28.0, 0.0, 0.0]), (0.32, [38.0, 0.0, 0.0]), (0.6, ZERO))]}),
            "hurt": clip(0.4, False, 0.16, {"body": [frames("rotation", (0.0, ZERO), (0.16, [0.0, 0.0, -11.0]), (0.4, ZERO))]}),
    ...
    "ash_ram": {
        ...
        "clips": {
            "idle": clip(3.5, True, 0.9, {
                "head": [frames("rotation", (0.0, ZERO), (0.9, [5.0, -5.0, 0.0]), (1.75, ZERO), (2.6, [3.0, 5.0, 0.0]), (3.5, ZERO))],
                "tail": [frames("rotation", (0.0, ZERO), (0.9, [0.0, 0.0, 6.0]), (1.75, ZERO), (2.6, [0.0, 0.0, -5.0]), (3.5, ZERO))],
            }),
            "walk": clip(1.0, True, 0.25, {
                "leg_fl": [frames("rotation", (0.0, [18.0, 0.0, 0.0]), (0.5, [-18.0, 0.0, 0.0]), (1.0, [18.0, 0.0, 0.0]))],
                "leg_fr": [frames("rotation", (0.0, [-18.0, 0.0, 0.0]), (0.5, [18.0, 0.0, 0.0]), (1.0, [-18.0, 0.0, 0.0]))],
                "leg_bl": [frames("rotation", (0.0, [-16.0, 0.0, 0.0]), (0.5, [16.0, 0.0, 0.0]), (1.0, [-16.0, 0.0, 0.0]))],
                "leg_br": [frames("rotation", (0.0, [16.0, 0.0, 0.0]), (0.5, [-16.0, 0.0, 0.0]), (1.0, [16.0, 0.0, 0.0]))],
            }),
            "headbutt_pose": clip(0.85, False, 0.45, {
                "body": [frames("position", (0.0, ZERO), (0.25, [0.0, 0.0, 0.5]), (0.48, [0.0, 0.0, -1.1]), (0.85, ZERO))],
                "head": [frames("rotation", (0.0, ZERO), (0.25, [-10.0, 0.0, 0.0]), (0.48, [18.0, 0.0, 0.0]), (0.85, ZERO))],
            }),
    ...
    "fire_bloom": {
        ...
        "clips": {
            "glow_idle": clip(3.2, True, 0.8, {"chassis": [frames("scale", (0.0, [1.0, 1.0, 1.0]), (0.8, [1.025, 1.04, 1.025]), (1.6, [1.05, 1.065, 1.05]), (2.4, [1.025, 1.04, 1.025]), (3.2, [1.0, 1.0, 1.0]))]}),
        },
    },
    "smoke_reed": {
        "class": "animated_plant_sway",
        "clips": {
            "sway": clip(4.0, True, 1.0, {
                "stem": [frames("rotation", (0.0, ZERO), (1.0, [0.8, 0.0, 2.7]), (2.0, ZERO), (3.0, [-0.6, 0.0, -2.2]), (4.0, ZERO))],
                "head": [frames("rotation", (0.0, ZERO), (1.0, [0.4, 0.0, 1.4]), (2.0, ZERO), (3.0, [-0.3, 0.0, -1.1]), (4.0, ZERO))],
            }),
        },
    },
    "ember_forge": {
        ...
        "clips": {
            "glow_idle": clip(3.2, True, 0.8, {"chassis": [frames("scale", (0.0, [1.0, 1.0, 1.0]), (0.8, [1.015, 1.025, 1.015]), (1.6, [1.035, 1.045, 1.035]), (2.4, [1.015, 1.025, 1.015]), (3.2, [1.0, 1.0, 1.0]))]}),
        },
    },
    "ancient_kiln": {"class": "static_landmark_prop", "clips": {}},
}
...
def execute(inputs: Inputs) -> tuple[int, dict[str, Any]]:
    ...
    if brief.get("name") != inputs.asset or brief.get("model_identifier") != f"geometry.aionforge_ah.{inputs.asset}":
    ...
    receipt = {
        "schema": "aionforge.wave1.ashen.representative_native.v1",
