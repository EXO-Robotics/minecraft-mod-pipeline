#!/usr/bin/env python3
"""Build the deterministic aggregate Ashen landmark visual-native receipt."""
...
OUTPUT = HERE / "ASHEN_LANDMARK_NATIVE_REPORT.json"
INTEGRATION_TREE = "673c9ea44cfc6c650cc486034dd3ac30c2e48af8"
...
def build() -> dict:
    ...
    return {
        "schema": "aionforge.wave1.ashen.landmark_native.aggregate.v1",
        "status": "PASS_NATIVE_REPAIR_GATE",
        "integration_authority": {"commit": INTEGRATION_COMMIT, "tree": INTEGRATION_TREE},
        "scope": list(ASSETS),
        "excluded_representatives": ["ember_forge", "ancient_kiln"],
        "tooling": {
