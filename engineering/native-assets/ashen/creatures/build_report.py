#!/usr/bin/env python3
"""Build the deterministic aggregate receipt for the remaining Ashen creatures."""
...
OUTPUT = HERE / "ASHEN_CREATURE_NATIVE_REPORT.json"
ASSETS = tuple(author.SPECS)
SOURCE_COMMIT = author.INTEGRATION_COMMIT
...
def build() -> dict:
    ...
    return {
        "schema": "aionforge.wave1.ashen.creature_native.aggregate.v1",
        ...
        "integration_authority": {"commit": SOURCE_COMMIT},
        "scope": list(ASSETS),
        "tooling": {"blockbench_version": "5.1.6", "transport": "CDP_LOOPBACK_ONLY", "endpoint": "http://127.0.0.1:9264", "extensions_disabled": True},
        "totals": totals,
        "assets": assets,
        "proof_boundaries": {
