#!/usr/bin/env python3
"""Build the deterministic native-only report for four Packet 006 assets."""
...
OUTPUT = HERE / "PACKET006_MISSING_NATIVE_REPORT.json"
...
def build() -> dict:
    ...
    return {
        "schema": "aionforge.wave1.packet006.missing_native.aggregate.v1",
        ...
        "proof_boundary": {
            "proves": ["BLOCKBENCH_5_1_6_NATIVE_EDITABLE_ROUNDTRIP", "EXACT_BRIEF_CLIP_SET", "TRUE_NATIVE_LOCATORS", "TWO_NATIVE_EXPORT_CYCLES_CANONICALLY_EQUIVALENT", "TEXTURE_BYTES_PRESERVED"],
            "does_not_prove": ["BP_RP", "ITEM_REGISTRATION", "RECIPES", "RUNTIME", "PRODUCT_SEMANTICS", "AUTHORITY", "GAMEPLAY", "BDS", "BEDROCK_CLIENT", "MULTIPLAYER", "PHYSICAL_PS4", "MARKETPLACE", "RELEASE"],
        },
    }
