#!/usr/bin/env python3
"""Build the deterministic aggregate receipt for remaining Crystal Marsh creatures."""
...
OUTPUT = HERE / "CRYSTAL_MARSH_CREATURE_NATIVE_REPORT.json"
...
def build() -> dict:
    ...
    return {
        "schema": "aionforge.wave1.crystal_marsh.creature_native.aggregate.v1",
