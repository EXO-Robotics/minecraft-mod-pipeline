#!/usr/bin/env python3
"""Native Blockbench repair gate for seven Packet 003 representatives.
...
INTEGRATION_COMMIT = "9235ff0fb375a025127888b618e2818994206d5a"
KEYFRAME_TOLERANCE_SECONDS = 0.026
RECEIPT_NAME = "crystal-marsh-representative-native-receipt.json"
ZERO = [0.0, 0.0, 0.0]
...
SPECS: dict[str, dict[str, Any]] = {
    "marsh_wight": {
        ...
        "clips": {
            "idle_sway": clip(3.6, True, 0.9, {
                "torso": [frames("rotation", (0.0, ZERO), (0.9, [1.5, 0.0, 1.8]), (1.8, ZERO), (2.7, [-1.0, 0.0, -1.5]), (3.6, ZERO))],
                "head": [frames("rotation", (0.0, ZERO), (0.9, [2.0, -5.0, 0.0]), (1.8, ZERO), (2.7, [1.0, 4.0, 0.0]), (3.6, ZERO))],
            }),
            "drift_walk": clip(1.2, True, 0.3, {
                "leg_l": [frames("rotation", (0.0, [15.0, 0.0, 0.0]), (0.6, [-15.0, 0.0, 0.0]), (1.2, [15.0, 0.0, 0.0]))],
                "leg_r": [frames("rotation", (0.0, [-15.0, 0.0, 0.0]), (0.6, [15.0, 0.0, 0.0]), (1.2, [-15.0, 0.0, 0.0]))],
                "torso": [frames("position", (0.0, ZERO), (0.3, [0.0, 0.25, 0.0]), (0.6, ZERO), (0.9, [0.0, 0.18, 0.0]), (1.2, ZERO))],
            }),
            "reach_attack": clip(0.8, False, 0.38, {
                "torso": [frames("position", (0.0, ZERO), (0.22, [0.0, 0.0, 0.45]), (0.42, [0.0, 0.0, -0.9]), (0.8, ZERO))],
                "arm_l": [frames("rotation", (0.0, ZERO), (0.38, [-42.0, 0.0, -9.0]), (0.8, ZERO))],
                "arm_r": [frames("rotation", (0.0, ZERO), (0.38, [-42.0, 0.0, 9.0]), (0.8, ZERO))],
            }),
            "hurt": clip(0.45, False, 0.18, {"torso": [frames("rotation", (0.0, ZERO), (0.18, [0.0, 0.0, 10.0]), (0.45, ZERO))]}),
            "death_collapse": clip(1.25, False, 1.25, {"torso": [frames("rotation", (0.0, ZERO), (0.7, [22.0, 0.0, 15.0]), (1.25, [82.0, 0.0, 18.0]))]}),
        },
    },
    "crystal_dragonfly": {
        "class": "small_flying_creature",
        "clips": {
            "idle_hover": clip(2.4, True, 0.6, {
                "body": [frames("position", (0.0, ZERO), (0.6, [0.0, 0.35, 0.0]), (1.2, ZERO), (1.8, [0.0, -0.22, 0.0]), (2.4, ZERO))],
                "head": [frames("rotation", (0.0, ZERO), (0.6, [2.0, -7.0, 0.0]), (1.2, ZERO), (1.8, [1.0, 6.0, 0.0]), (2.4, ZERO))],
            }),
            "fly": clip(0.6, True, 0.15, {
                "wing_fl": [frames("rotation", (0.0, [0.0, 0.0, -30.0]), (0.15, [0.0, 0.0, 24.0]), (0.3, [0.0, 0.0, 30.0]), (0.45, [0.0, 0.0, -24.0]), (0.6, [0.0, 0.0, -30.0]))],
                "wing_fr": [frames("rotation", (0.0, [0.0, 0.0, 30.0]), (0.15, [0.0, 0.0, -24.0]), (0.3, [0.0, 0.0, -30.0]), (0.45, [0.0, 0.0, 24.0]), (0.6, [0.0, 0.0, 30.0]))],
                "wing_bl": [frames("rotation", (0.0, [0.0, 0.0, -22.0]), (0.15, [0.0, 0.0, 18.0]), (0.3, [0.0, 0.0, 22.0]), (0.45, [0.0, 0.0, -18.0]), (0.6, [0.0, 0.0, -22.0]))],
                "wing_br": [frames("rotation", (0.0, [0.0, 0.0, 22.0]), (0.15, [0.0, 0.0, -18.0]), (0.3, [0.0, 0.0, -22.0]), (0.45, [0.0, 0.0, 18.0]), (0.6, [0.0, 0.0, 22.0]))],
            }),
            "dart": clip(0.5, False, 0.22, {"body": [frames("rotation", (0.0, ZERO), (0.18, [-14.0, 0.0, 0.0]), (0.32, [-9.0, 0.0, 0.0]), (0.5, ZERO))]}),
    ...
    "silt_crocodile": {
        ...
        "clips": {
            "idle_submerge": clip(3.4, True, 0.85, {
                "body": [frames("position", (0.0, ZERO), (0.85, [0.0, -0.3, 0.0]), (1.7, ZERO), (2.55, [0.0, 0.18, 0.0]), (3.4, ZERO))],
                "tail": [frames("rotation", (0.0, ZERO), (0.85, [0.0, 5.0, 0.0]), (1.7, ZERO), (2.55, [0.0, -4.0, 0.0]), (3.4, ZERO))],
            }),
            "swim": clip(1.2, True, 0.3, {
                "tail": [frames("rotation", (0.0, [0.0, -16.0, 0.0]), (0.3, [0.0, 0.0, 0.0]), (0.6, [0.0, 16.0, 0.0]), (0.9, [0.0, 0.0, 0.0]), (1.2, [0.0, -16.0, 0.0]))],
                "body": [frames("rotation", (0.0, [0.0, -2.0, 0.0]), (0.6, [0.0, 2.0, 0.0]), (1.2, [0.0, -2.0, 0.0]))],
            }),
            "lunge": clip(0.8, False, 0.38, {
                "body": [frames("position", (0.0, ZERO), (0.22, [0.0, 0.0, 0.7]), (0.42, [0.0, 0.0, -1.4]), (0.8, ZERO))],
                "head": [frames("rotation", (0.0, ZERO), (0.38, [-10.0, 0.0, 0.0]), (0.8, ZERO))],
            }),
            "bite": clip(0.65, False, 0.3, {"head": [frames("rotation", (0.0, ZERO), (0.18, [-12.0, 0.0, 0.0]), (0.34, [20.0, 0.0, 0.0]), (0.65, ZERO))]}),
    ...
    "bubble_pod": {
        ...
        "clips": {
            "bob": clip(3.0, True, 0.75, {"head": [frames("position", (0.0, ZERO), (0.75, [0.0, 0.35, 0.0]), (1.5, ZERO), (2.25, [0.0, -0.18, 0.0]), (3.0, ZERO))]}),
        },
    },
    "flood_reed": {
        ...
        "clips": {
            "sway": clip(4.0, True, 1.0, {
                "stem": [frames("rotation", (0.0, ZERO), (1.0, [0.7, 0.0, 2.5]), (2.0, ZERO), (3.0, [-0.5, 0.0, -2.0]), (4.0, ZERO))],
                "head": [frames("rotation", (0.0, ZERO), (1.0, [0.4, 0.0, 1.3]), (2.0, ZERO), (3.0, [-0.3, 0.0, -1.0]), (4.0, ZERO))],
            }),
        },
    },
    "sunken_shrine": {
        ...
        "clips": {
            "glow": clip(3.2, True, 0.8, {"chassis": [frames("scale", (0.0, [1.0, 1.0, 1.0]), (0.8, [1.012, 1.02, 1.012]), (1.6, [1.03, 1.04, 1.03]), (2.4, [1.012, 1.02, 1.012]), (3.2, [1.0, 1.0, 1.0]))]}),
        },
    },
    "ancient_boat": {"class": "static_landmark_prop", "clips": {}},
}
...
def execute(inputs: Inputs) -> tuple[int, dict[str, Any]]:
    ...
    if brief.get("name") != inputs.asset or brief.get("model_identifier") != f"geometry.aionforge_cm.{inputs.asset}":
    ...
    receipt = {
        "schema": "aionforge.wave1.crystal_marsh.representative_native.v1",
