#!/usr/bin/env python3
"""Build the deterministic aggregate Skyreach landmark visual-native receipt."""
...
from author_landmarks import ASSETS, INTEGRATION_COMMIT, RECEIPT_NAME


HERE = Path(__file__).resolve().parent
OUTPUT = HERE / "SKYREACH_LANDMARK_NATIVE_REPORT.json"
INTEGRATION_TREE = "8530ed7a93a9e3bf7bcc5fcbef02050287371233"
...
def build() -> dict:
    ...
    return {
        "schema": "aionforge.wave1.skyreach.landmark_native.aggregate.v1",
        "status": "PASS_NATIVE_REPAIR_GATE",
        "integration_authority": {"commit": INTEGRATION_COMMIT, "tree": INTEGRATION_TREE},
        "scope": list(ASSETS),
        "excluded_representatives": ["wind_shrine", "observation_tower"],
        ...
        "proof_boundaries": {
            ...
            "does_not_prove": [
                "MCSTRUCTURE_ASSEMBLY", "WORLDGEN_PLACEMENT", "BP_RP_INTEGRATION", "GAMEPLAY", "BDS",
                "BEDROCK_CLIENT", "MULTIPLAYER", "PHYSICAL_PS4", "MARKETPLACE", "RELEASE",
            ],
