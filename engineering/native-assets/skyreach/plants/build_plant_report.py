#!/usr/bin/env python3
"""Build the deterministic aggregate Skyreach plant native receipt."""
...
OUTPUT = HERE / "SKYREACH_PLANT_NATIVE_REPORT.json"
...
def build() -> dict:
    ...
    return {
        "schema": "aionforge.wave1.skyreach.plant_native.aggregate.v1",
        "status": "PASS_NATIVE_REPAIR_GATE",
        "integration_authority": {"commit": INTEGRATION_COMMIT, "tree": INTEGRATION_TREE},
        "scope": list(ASSETS),
        "excluded_representatives": ["wind_reed_plant", "hanging_sky_vine"],
