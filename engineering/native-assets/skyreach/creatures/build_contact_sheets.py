...
def build() -> dict:
    ...
    manifest = {"schema": "aionforge.wave1.skyreach.creature_native_contact_sheets.v1", "assets": records}
    (HERE / "SKYREACH_CREATURE_NATIVE_CONTACT_SHEETS.json").write_text(json.dumps(manifest, sort_keys=True, separators=(",", ":")) + "\n")
    return manifest
