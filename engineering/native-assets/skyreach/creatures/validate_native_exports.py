...
OUTPUT = HERE / "SKYREACH_CREATURE_STATIC_VALIDATION.json"
...
def build() -> dict:
    ...
    for asset in author.SPECS:
        ...
        command = ["python3", str(VALIDATOR), "--geometry", str(geometry), "--texture", str(texture), "--namespace", "aionbound", "--required-locator", "effect", "--required-locator", "gaze"]
    ...
    return {
        "schema": "aionforge.wave1.skyreach.creature_native_static_validation.v1",
