#!/usr/bin/env python3
"""Build the deterministic aggregate receipt for the bounded Skyreach native gate."""
...
OUTPUT = HERE / "SKYREACH_REPRESENTATIVE_NATIVE_REPORT.json"
ASSETS = ("wind_roc", "gale_hawk", "cloud_goat", "wind_reed_plant", "hanging_sky_vine", "wind_shrine", "observation_tower")
SOURCE_COMMIT = "1810d0bb75e73be16d1c98e1d57dfe9ea485849d"
SOURCE_TREE = "11f377745f69b848396780dac1d039955fa90131"
RECEIPT = "skyreach-representative-native-receipt.json"
...
def build() -> dict:
    contact_manifest = HERE / "SKYREACH_REPRESENTATIVE_CONTACT_SHEETS.json"
    ...
    return {
        "schema": "aionforge.wave1.skyreach.representative_native.aggregate.v1",
        "status": "PASS_NATIVE_REPAIR_GATE",
        "integration_authority": {"commit": SOURCE_COMMIT, "tree": SOURCE_TREE},
        "scope": list(ASSETS),
        "tooling": {"blockbench_version": "5.1.6", "transport": "CDP_LOOPBACK_ONLY", "endpoint": "http://127.0.0.1:9268", "extensions_disabled": True},
