...
Runtime evidence binds artifact/build hashes, runtime/game version, world/test identity, harness version, required check IDs, timestamps, and raw log hash. Internal dispatcher calls cannot satisfy event-adapter tests. BDS cannot satisfy client, Realm, controller, or console gates.
