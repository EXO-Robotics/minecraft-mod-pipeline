...
const MODULE_NAMES = ["wave1_codex_data", "wave1_codex_ui_data", "wave1_equipment_roles", "whisperwood_regrowth", "catalog", "budgets", "state", "router", "codex", "combat", "devices", "encounters", "thorn_court", "chaos", "structures", "runtime", "main"];
...
test("shipping scripts use approved stable APIs only and one central arbiter", async () => {
  const scripts = ["main.js", "runtime.js", "catalog.js", "wave1_codex_data.js", "wave1_codex_ui_data.js", "wave1_equipment_roles.js", "whisperwood_regrowth.js", "budgets.js", "state.js", "router.js", "codex.js", "combat.js", "devices.js", "encounters.js", "thorn_court.js", "chaos.js", "structures.js"];
