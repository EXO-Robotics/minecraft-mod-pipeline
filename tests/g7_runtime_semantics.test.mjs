...
const MODULE_NAMES = ["wave1_codex_extension_data", "wave1_codex_ashen_data", "wave1_codex_data", "wave1_codex_ui_data", "wave1_equipment_roles", "whisperwood_regrowth", "whisperwood_rewards", "catalog", "budgets", "state", "router", "codex", "combat", "devices", "encounters", "thorn_court", "chaos", "structures", "runtime", "main"];
